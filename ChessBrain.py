...
def find_best_move(gs, valid_moves, return_queue):
    ...
    find_negamax_move_alpha_beta_pruning(
        gs, valid_moves, DEPTH, -CHECKMATE, CHECKMATE, 1 if gs.white_to_move else -1)
